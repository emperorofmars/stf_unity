...
#if UNITY_EDITOR
	[InitializeOnLoad]
	public class Register_STFEXP_Collider_Capsule_Processor
	{
		static Register_STFEXP_Collider_Capsule_Processor()
		{
			STF_Processor_Registry.RegisterProcessor("default", new STFEXP_Collider_Capsule_Processor());
		}
	}
#endif
}
