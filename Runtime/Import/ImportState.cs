...
namespace com.squirrelbite.stf_unity
{
	public class ImportState
	{
		...
		public ImportState(STF_File File, Dictionary<string, ISTF_Handler> Handlers, HashSet<string> Ignores, ImportOptions ImportConfig = null)
		{
			...
			if (ImportConfig.IsFirstImport && Meta.AssetProperties.Find(p => p.Name == "import.context.default") is var defaultContext && defaultContext != null && !string.IsNullOrWhiteSpace(defaultContext.Value) && STF_Processor_Registry.GetAvailableContexts().Contains(defaultContext.Value))
			{
