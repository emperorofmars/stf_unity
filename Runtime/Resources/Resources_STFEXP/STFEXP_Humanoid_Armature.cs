...
{
	[AddComponentMenu("STF/Resources/stfexp/stfexp.armature.humanoid")]
	[HelpURL("https://docs.stfform.at/resources/stfexp/stfexp_armature_humanoid.html")]
	...
	public class STFEXP_Humanoid_Armature_Handler : ISTF_Handler
	{
		...
		public List<System.Type> UnderstoodApplicationTypes => new(){typeof(STFEXP_Humanoid_Armature)};
