...
{
	[AddComponentMenu("STF/Resources/stf/stf.node")]
	[HelpURL("https://docs.stfform.at/resources/stf/stf_node.html")]
	...
	public class STF_Node_Handler : ISTF_Handler
	{
		public string STF_Type => STF_Node.STF_TYPE;
		public string STF_Category => "node";
		public int Priority => 0;
		public List<string> LikeTypes => new(){"node"};
		public List<System.Type> UnderstoodApplicationTypes => new(){typeof(STF_Node)};
