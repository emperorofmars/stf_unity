...
namespace com.squirrelbite.stf_unity.ava.vrchat.modules
{
	public abstract class VRC_ContactBase : STF_NodeComponentResource
	{
		...
		public bool filter_components_avatar = false;
		public bool filter_components_world = false;
		public bool filter_local_only = false;
		...
		public void ParseBase(JObject JsonResource)
		{
			...
			if(JsonResource.ContainsKey("filter_avatar")) this.filter_components_avatar = JsonResource.Value<bool>("filter_avatar");
			if(JsonResource.ContainsKey("filter_world")) this.filter_components_world = JsonResource.Value<bool>("filter_world");
			if(JsonResource.ContainsKey("filter_local_only")) this.filter_local_only = JsonResource.Value<bool>("filter_local_only");
