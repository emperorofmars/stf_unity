...
{
	[AddComponentMenu("STF/Resources/com.vrchat/com.vrchat.contact_receiver")]
	...
	public class VRC_ContactReceiver_Module : ISTF_Handler
	{
	...
	class Register_VRC_ContactReceiver_Module
	{
		...
		{
			STF_Handler_Registry.RegisterHandler(new VRC_ContactReceiver_Module());
		}
	}
#endif
}
