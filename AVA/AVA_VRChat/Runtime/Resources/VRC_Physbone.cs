...
{
	[AddComponentMenu("STF/Resources/com.vrchat/com.vrchat.physbone")]
	...
	public class VRC_Physbone_Module : ISTF_Handler
	{
	...
	class Register_VRC_Physbone_Module
	{
		...
		{
			STF_Handler_Registry.RegisterHandler(new VRC_Physbone_Module());
		}
	}
#endif
}
