...
namespace com.squirrelbite.stf_unity.ava.vrchat
{
	...
	public class DetectorVRC
	{
		...
		public static readonly List<System.Type> Ignores = new() { typeof(STFEXP_Collider_Sphere), typeof(STFEXP_Collider_Capsule), typeof(STFEXP_Collider_Plane), typeof(STFEXP_Constraint_Twist), };
