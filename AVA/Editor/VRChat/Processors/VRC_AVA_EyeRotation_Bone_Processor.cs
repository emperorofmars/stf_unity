...
{
	public class VRC_AVA_EyeRotation_Bone_Processor : ISTF_Processor
	{
	...
	public class Register_VRC_AVA_EyeRotation_Bone
	{
		...
		{
			STF_Processor_Registry.RegisterProcessor(DetectorVRC.STF_VRC_AVATAR_CONTEXT, new VRC_AVA_EyeRotation_Bone_Processor());
		}
	}
}
