...
namespace com.squirrelbite.stf_unity.ava
{
	...
	public class AVA_Visemes_Blendshape_Module : ISTF_Handler
	{
		...
		public List<System.Type> UnderstoodApplicationTypes => new(){typeof(AVA_Visemes_Blendshape)};
	...
	class Register_AVA_Visemes_Blendshape_Module
	{
		...
		{
			STF_Handler_Registry.RegisterHandler(new AVA_Visemes_Blendshape_Module());
		}
	}
#endif
}
