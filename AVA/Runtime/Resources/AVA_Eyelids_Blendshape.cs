...
{
	[AddComponentMenu("STF/Resources/ava/ava.eyelids.blendshape")]
	[HelpURL("https://docs.stfform.at/resources/ava/ava_eyelids_blendshape.html")]
	...
	public class AVA_Eyelids_Blendshape_Module : ISTF_Handler
	{
		...
		public List<System.Type> UnderstoodApplicationTypes => new(){typeof(AVA_Eyelids_Blendshape)};
	...
	class Register_AVA_Eyelids_Blendshape_Module
	{
		...
		{
			STF_Handler_Registry.RegisterHandler(new AVA_Eyelids_Blendshape_Module());
		}
	}
#endif
}
