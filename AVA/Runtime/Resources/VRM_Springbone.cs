...
{
	[AddComponentMenu("STF/Resources/dev.vrm/dev.vrm.springbone")]
	...
	public class VRM_Springbone_Module : ISTF_Handler
	{
	...
	class Register_VRM_Springbone_Module
	{
		...
		{
			STF_Handler_Registry.RegisterHandler(new VRM_Springbone_Module());
		}
	}
#endif
}
